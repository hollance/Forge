  ...
  uint2 gid [[thread_position_in_grid]])
{
  ...
  // Convert white to black and black to white. The network is trained on
  // white-on-black images but we want to detect black-on-white digits, as
  ...
  // Write rotated 90 degrees clockwise. (Images are assumed to be 28 wide.)
  //outTexture.write(outColor, uint2(outTexture.get_height() - 1 - gid.y, gid.x));
